...
class TrajectoryActionClient(Node):
    def __init__(self, freq: float, num_joints: int, single: bool,
        ...
        self.joint_names = [f'L_joint{i+1}' for i in range(self.num_joints)]
        ...
        self.create_subscription(JointState, '/spr_arm_driver_l/joint_states', self.joint_state_cb, joint_state_qos)

        # action client
        self.action_client = ActionClient(self, FollowJointTrajectory, '/spr_arm_driver_l/follow_joint_trajectory')
